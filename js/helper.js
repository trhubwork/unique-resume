...
var HTMLgithub = '<li class="flex-item"><span id="contact-data">github</span><span class="contact-value">%data%</span></li>';
var HTMLblog = '<li class="flex-item"><span id="contact-data">blog</span><span class="contact-value">%data%</span></li>';
